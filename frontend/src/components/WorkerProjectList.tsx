...
const WorkerProjectList = () => {
  ...
  const cardGrid =
    "grid gap-6 w-full grid-cols-[repeat(auto-fit,minmax(240px,1fr))]";
  if (!isFetched) {
    return <Loading full />;
  }
  return (
            ...
            const progress =
              parseInt(project.total_works) === 0
                ...
                : ((parseInt(project.total_works) -
                    ...
                    parseInt(project.total_works)) *
                  100;
            console.log(progress, project.total_works, project.pending_works);
            return (
              <Card key={project.project_id} className="shadow-md">
                <CardContent className="p-4 flex flex-col gap-3">
                  <div className="flex flex-col gap-1 sm:flex-row sm:justify-between sm:items-center">
                    <div className="text-base font-semibold text-blue-800 truncate">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      navigate(`/working/${project.project_id}`, {
                        state: {
                          project: project, // pass any object here
                        },
                      })
                    }
                  >
